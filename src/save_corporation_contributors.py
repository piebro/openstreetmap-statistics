...
name_url_function = [
    ...
    ["Baly", "https://wiki.openstreetmap.org/wiki/Baly", get_usernames_from_links],
    ...
    ["GOAT", "https://wiki.openstreetmap.org/wiki/GOAT_(Geo_Open_Accessibility_Tool)", get_usernames_from_links],
    ...
    ["OpenSidewalks", "https://wiki.openstreetmap.org/wiki/Organised_Editing/Activities/OpenSidewalks", get_usernames_from_links],
    ["Ozon", "https://wiki.openstreetmap.org/wiki/Organised_Editing/Activities/Ozon", get_usernames_from_links],
