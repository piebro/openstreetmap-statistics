    ...
    with bz2.open(input_file, "rt", encoding="utf-8") as infile:
        ...
        for line_num, line in enumerate(infile):
            if line_num % 5_000_000 == 0:
                print(f"Processed {line_num:,} lines, found {changeset_count:,} changesets, collected {collected_count} changesets")
...
def main():
    ...
    create_test_dataset(
        args.input_file, args.output_file, args.skip_interval
    )
    print("Completed!")
